...
export function NavBar() {
    ...
    const title = useColorModeValue("purple.800", "yellow.200")
    const subTitle = useColorModeValue("gray.900", "gray.300")

  return (
    <Box bg={bg} w="600px" h="100vh" p="24px">
        <ButtonColorSwitch />
      <Heading as="h1" size="4xl" textAlign="center" mt="50px" color={title}>
        Luz Do Mundo
      </Heading>
      ...
      <Flex m="auto" mt="120px" ml="70px">
        <Text>
            "Enquanto estou no mundo, sou a luz do mundo". <br />

            <Text pos="relative" left="160px" top="10px" color={subTitle} >João 8:12</Text>
        </Text>
      </Flex>
    </Box>
  );
